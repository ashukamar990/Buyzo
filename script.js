...
import { getDatabase, ref, set, get, child, push } from "https://www.gstatic.com/firebasejs/12.2.1/firebase-database.js";
...
// Firebase function to save order
...
// Firebase function to get orders
function getOrdersFromFirebase(callback) {
  const ordersRef = ref(database, 'orders/');
...
// Firebase function to cancel order
function cancelOrderInFirebase(orderId) {
  // Note: This would require a different data structure to properly identify orders
  // For now, we'll keep using localStorage but you can modify this as needed
  console.log("Would cancel order in Firebase with ID:", orderId);
}
...
document.getElementById('confirmOrder').addEventListener('click', ()=>{
  ...
  // Also save to localStorage for demo purposes (can be removed later)
...
// demo save order (can be removed after Firebase integration is complete)
