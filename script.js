    ...
    function loadSampleCategories() {
      categories = [
        ...
        },
        {
          id: '3',
          name: 'Home & Kitchen',
          image: 'https://images.unsplash.com/photo-1556228453-efd6c1ff04f6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8aG9tZSUyMGFuZCUyMGtpdGNoZW58ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60'
        },
        {
          id: '4',
          name: 'Beauty',
          image: 'https://images.unsplash.com/photo-1596462502278-27bfdc403348?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8YmVhdXR5fGVufDB8fDB8fHww%3D&auto=format&fit=crop&w=500&q=60'
        }
      ];
    ...
    function loadSampleBanners() {
      banners = [
        ...
        {
          id: '2',
          image: 'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8c2hvcHBpbmd8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=800&q=60'
        },
        {
          id: '3',
          image: 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8c2hvcHBpbmd8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=800&q=60'
        }
      ];
    ...
    function createOrderCard(order) {
      ...
      orderCard.innerHTML = `
        ...
        <div class="order-details">
          <div class="order-product-image" style="background-image: url('${order.productImage || 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8cHJvZHVjdHxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=500&q=60'}')"></div>
          <div class="order-product-info">
            <div class="order-product-title">${order.productName}</div>
            <div class="order-product-price">${order.price}</div>
            <div class="order-product-meta">Quantity: ${order.quantity} | Size: ${order.size}</div>
          </div>
        </div>
        <div class="order-actions">
          <button class="btn secondary view-order-detail" data-order-id="${order.orderId}">View Details</button>
          <button class="btn secondary track-order" data-order-id="${order.orderId}">Track Order</button>
          <button class="btn error cancel-order" data-order-id="${order.orderId}">Cancel Order</button>
        </div>
      `;
      
      // Add event listeners
      orderCard.querySelector('.view-order-detail').addEventListener('click', () => viewOrderDetail(order.orderId));
      orderCard.querySelector('.track-order').addEventListener('click', () => trackOrder(order.orderId));
      orderCard.querySelector('.cancel-order').addEventListener('click', () => cancelOrder(order.orderId));
    ...
    function cancelOrder(orderId) {
      // In a real app, you would show a cancellation modal
      showToast(`Cancelling order: ${orderId}`, 'info');
      // For now, just show a toast message
    }

    // NEW: Function to show My Orders with Realtime DB data
